...
function getPlatformIcon(filename){
    ...
    // Si la app está empaquetada, buscamos fuera del .asar
    if (app.isPackaged) {
        // En producción, los recursos suelen estar en process.resourcesPath
        return path.join(process.resourcesPath, 'app', 'assets', 'images', `${filename}.${ext}`);
    }

    // En desarrollo, mantenemos tu lógica original
